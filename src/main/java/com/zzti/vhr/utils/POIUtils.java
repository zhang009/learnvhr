...
public class POIUtils {
    public static ResponseEntity<byte[]> employee2Excel(List<Employee> list) {
        ...
        //创建表单
        HSSFSheet sheet = workbook.createSheet("员工信息表");//参数为表单的名字Style
        //定义列的宽度
        sheet.setColumnWidth(0,5*256);//第一个参数为第几列，第二个参数为宽度
    ...
    * @Param file:
     ...
     * @Param allPositions:
     * @Param allJobLevels:
    * @return: java.util.List<com.zzti.vhr.model.Employee>
    **/
